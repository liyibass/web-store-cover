...
import "./SearchProductCardPreview.style.scss";

import { useDispatch } from "react-redux";
import { addCartItems } from "../../../redux/cart/cart.action";

function SearchProductCardPreview({ product }) {
  const dispatch = useDispatch();

  return (
    <div className="SearchProductCardPreview col-lg-3">
...
export default SearchProductCardPreview;
